        ...
        'gmail' => [
            ...
            'fields' => [
                    ...
                    'html' => '
                        <div x-data="{ open: false }" class="mb-6">
                            <button 
                                @click="open = !open" 
                                type="button"
                                class="w-full rounded-lg bg-primary-50 border border-primary-200 p-4 hover:bg-primary-100 transition-colors"
                            >
                            ...
                            >
                                <div class="mt-2 rounded-lg bg-white border border-gray-200 p-6 space-y-4">
                                    <div>
                ...
                'gmail_client_id' => [
                    ...
                    'helper_text' => 'Encontrado en: Google Cloud Console > APIs y Servicios > Credenciales',
                    'required' => false,
                    'rules' => [],
                ],
                'gmail_client_secret' => [
                    ...
                    'helper_text' => 'Mantén esto seguro y nunca lo compartas públicamente',
                    'required' => false,
                    'rules' => [],
                ],
                'gmail_refresh_token' => [
                    ...
                    'helper_text' => 'Obtén esto desde Google OAuth Playground usando los pasos anteriores',
                    'required' => false,
                    'rules' => [],
                ],
                'gmail_user_email' => [
                    ...
                    'helper_text' => 'La dirección de correo de la cuenta de Gmail que deseas acceder',
                    'required' => false,
                    'rules' => ['email'],
                ],
                'test_connection' => [
                    'type' => 'button',
                    'label' => 'Probar conexión de Gmail',
